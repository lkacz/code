...
const crafting = (function(){
  ...
  const SOURCE_HINTS = {
    ...
    rubber: 'ścinaj kauczukowce — smukłe, wysokopienne drzewa w lasach',
    rubberBall: 'craft: kauczuk ubity w kulki (Broń)',
    rubberBallTar: 'craft: kauczuk nasycony węglem na smołę (Broń)',
    vine: 'zrywaj pnącza zwisające z bagiennych drzew (mangrowców)',
    leaf: 'korony drzew',
    ...
    rope: 'craft: skręć pnącza w linę (Przerób)',
