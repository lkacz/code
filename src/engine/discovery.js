...
const discovery = (function(){
  ...
  const HINTS = {
    ...
    slain_guardian_fire:  {cat:'📖 Bestiariusz', hint:'Ukój wschodni żar, a jego serce trafi do kroniki…'},
    slain_guardian_ice:   {cat:'📖 Bestiariusz', hint:'Zgaś zachodni chłód, by zapisać go w bestiariuszu…'},
    slain_guardian_earth: {cat:'📖 Bestiariusz', hint:'Obudź i uśpij Trzeciego Kreta pod ziemią…'},
    slain_guardian_air:   {cat:'📖 Bestiariusz', hint:'Ściągnij ambicję z nieba, a karta się odsłoni…'},
    slain_guardian_mother:{cat:'📖 Bestiariusz', hint:'Dotrzyj do samego środka świata i spotkaj siebie…'},
    ...
    graphite:       {cat:'⚙ Przemysł',           hint:'Pozwól czarnemu dymowi długo osiadać w jednym miejscu…'},
    graphene:       {cat:'⚙ Przemysł',           hint:'Grafitowa żyła a raz po raz uderzający w nią prąd…'},
    smr:            {cat:'⚙ Przemysł',           hint:'Grafit, coś promieniotwórczego i garść elektroniki…'},
    ...
    lightning_rod:  {cat:'⚙ Przemysł',           hint:'Postaw wysoki metalowy maszt i poczekaj na burzę…'},
