...
export function isMeteorPickSparkMaterial(t){
  return isMeteorPickDenseRockMaterial(t) || t===T.COAL || t===T.OBSIDIAN ||
...
export function isMeteorLifeSiteTile(t){
  return t===T.GRASS || t===T.MUD || t===T.ALIEN_BIOMASS;
}

export function isMeteorSettlementSiteTile(t){
  const info=INFO[t] || INFO[T.AIR];
  return !!(info && (info.machine || info.chestTier)) ||
...
export function isStructuralMaterial(t){
  return t===T.STONE || t===T.GRANITE || t===T.BASALT || t===T.BEDROCK ||
    t===T.STEEL || t===T.METEORIC_IRON || t===T.IRIDIUM || t===T.OBSIDIAN;
}

export function isMetalStructuralMaterial(t){
  return t===T.STEEL || t===T.METEORIC_IRON || t===T.IRIDIUM;
}

export function isRockStructuralMaterial(t){
  return t===T.STONE || t===T.GRANITE || t===T.BASALT || t===T.OBSIDIAN || t===T.BEDROCK;
}

export function isLightStructuralMaterial(t){
  return t===T.WOOD || t===T.ALIEN_BIOMASS;
}
...
export function isNonStructuralResourceMaterial(t){
  return t===T.COAL || t===T.RADIOACTIVE_ORE || t===T.ELECTRONICS || t===T.METEOR_DUST;
}
...
export function isUtilityMaterial(t){
  ...
  return !!(info && (info.machine || info.chestTier || info.gas || info.looseItem));
}
...
export function isLooseRigidMaterial(t){
  return t===T.DIAMOND || t===T.ELECTRONICS || t===T.COAL || t===T.RADIOACTIVE_ORE;
}
...
export function materialPhysicsRoute(t){
  ...
  if(info.looseItem) return 'loose-item';
  if(t===T.SAND) return 'granular';
...
export function isRubbleTrackedMaterial(t){
  return t!==T.BEDROCK && (isStructuralMaterial(t) || isPlayerBuiltMaterial(t));
}
...
export function isBuildFoundationTile(t){
  ...
  if(isFragileFallingMaterial(t) || isLooseRigidMaterial(t)) return false;
  return isHardStructuralMaterial(t) || isLightStructuralMaterial(t) || isWeakFillMaterial(t) || t===T.ICE || t===T.ANTIMATTER_CRYSTAL;
}
...
export function generatedCitySupportTile(t){
  return isStructuralMaterial(t) || isBuildAnchorTile(t) || isWeakFillMaterial(t);
}
