...
(function(){
  ...
  const BUILTIN_ITEMS=[
    ...
    {id:'throw_ap_mine',  kind:'weapon', weaponType:'thrown', thrownKind:'antipersonnelMine', name:'Rzut: Miny przeciwpiechotne', attackDamage:0, fireCooldown:0.72, desc:'Rzucona mina opada na podłoże, uzbraja się i wybucha po nadepnięciu — także przez bohatera lub moba; krater ma promień 3 pól'},
    {id:'throw_frag_mine',kind:'weapon', weaponType:'thrown', thrownKind:'fragmentationMine', name:'Rzut: Miny odłamkowe', attackDamage:0, fireCooldown:0.82, desc:'Jak mina przeciwpiechotna, ale wybuch dodatkowo rozrzuca odłamki; im bliżej detonacji, tym większe obrażenia'},
  ...
  const RESOURCES=[
    ...
    {key:'kiln', label:'Piec wypalowy', color:'#9c5b3a', tile:'KILN'},
    ...
    {key:'antipersonnelMine', label:'Miny przeciwpiechotne', color:'#46505a', tile:null},
    {key:'fragmentationMine', label:'Miny odłamkowe', color:'#c88945', tile:null},
