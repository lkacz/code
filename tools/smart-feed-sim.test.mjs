...
queue.push({kind:'world',text:'Nadciąga burza',dedupeKey:'weather:storm',target:{x:10,y:20}},10200);
const storm=queue.promote(10200);
assert.equal(storm.count,1);
const merged=queue.push({kind:'world',text:'Nadciąga burza',dedupeKey:'weather:storm',target:{x:30,y:40}},10700);
...
queue.push({kind:'world',text:'Nadciąga burza',dedupeKey:'weather:storm'},10800);
