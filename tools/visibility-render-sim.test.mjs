...
assert.match(mainSource, /const openArtTile=t===T\.GLOWSHROOM \|\| t===T\.LEAF_PILE \|\| t===T\.METEOR_DUST \|\| t===T\.WEATHERVANE \|\| t===T\.LIGHTNING_ROD;/, 'open organic, dust and instrument tiles keep transparent silhouettes instead of colored square backplates');
