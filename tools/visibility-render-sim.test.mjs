...
assert.match(mainSource, /return t===T\.SAND \|\| t===T\.CLAY \|\| t===T\.WET_CLAY \|\| t===T\.BRICK \|\| t===T\.DIRT \|\| t===T\.STONE \|\| t===T\.GRANITE \|\| t===T\.BASALT \|\| t===T\.BEDROCK \|\| t===T\.COAL \|\| t===T\.UFO_CONCRETE;/, 'sand, clay, brick, dirt, rock, coal and UFO concrete opt into characteristic pattern textures');
